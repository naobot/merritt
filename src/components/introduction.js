...
export default function Introduction({ children }) {
  ...
  return (
    ...
    <Section id="intro-2">
      <div className="text-container">
        <div className="text-content">
          <p>Love songs encompass celebrations of love and loved ones. They also mark trajectories of desire, acknowledging the distance between what is and what could be. The title for the exhibition comes from Johnson’s sculpture <em>Love Song (translation basket)</em>, which speaks directly to the need to understand the beat of every heart as a love song, and the fundamental changes that translation and understanding can bring about. Taking a heartbeat as a love song, as a rhythm that sings connection, requires belief in more than we can see. To live in the space of a love song, a good one, is to honour and celebrate connection and community beyond who and what we know. It is to believe in feeling made flesh, of belief made manifest, of justice come to fruition. It is often a complicated place to be, but Johnson offers ideas about how to fortify ourselves for this labour: by rejecting control masquerading as love, and to instead celebrate connection and interdependence.</p>

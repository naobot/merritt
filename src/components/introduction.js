    ...
    <Section id="intro-2">
      <div className="text-container">
        <div className="text-content">
          ...
          made manifest, of justice come to fruition. It is often a complicated place to be, but Johnson has
          some ideas about how to fortify ourselves for this labour.</p>
          <p>In the image above, Mindset, the sweetgrass headset offers temporary disconnection from toxic
